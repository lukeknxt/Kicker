        ...
        return (
            <div className="App">
              ...
              <div className="displayValues">
                  ...
                  <div style={radiusStyle}>radius<br/> {this.cv().radius}m</div>
                  <div style={greentTextStyle}>length<br/> {this.cv().length}m</div>
                  <div style={footStyle}>foot<br/> {this.cv().foot}m</div>
                  <div style={deepthStyle}>deepth<br/> {this.cv().deepth}m</div>
              ...
              <div className="inputs">
                ...
                <a className="numbers">{this.state.angle}&#176;</a>
                  ...
                  <div className="inputs" style={heightStyle}> <a className="numbers">   HEIGHT   </a>
                        <input  name="height" type="range" min="0.1" max="4" step="0.1" onChange={this.handleChange.bind(this)} value={this.state.height}/>
